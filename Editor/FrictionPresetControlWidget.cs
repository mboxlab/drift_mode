...
//	private readonly AltCurveControlWidget CurveControl;
...
//		CurveControl = Layout.Add( new AltCurveControlWidget( obj.GetProperty( "Curve" ) ) { MinimumHeight = 80f, Enabled = false } );
