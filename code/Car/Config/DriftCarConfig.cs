...
public class DriftCarConfig : ICarConfig
{

	public override DriveType DriveType { get; set; } = DriveType.RWD;
	public override bool AutomaticGearBox { get; set; } = true;
	public override float MaxMotorTorque { get; set; } = 350f;
	public override float MaxRPM { get; set; } = 7000f;
	public override float MinRPM { get; set; } = 700f;
	public override float CutOffRPM { get; set; } = 6800f;
	public override float CutOffOffsetRPM { get; set; } = 500f;
	...
	public override float MaxSteerAngle { get; set; } = 40f;
	public override float SteerAngleChangeSpeed { get; set; } = 5f;
	public override float MinSpeedForSteerHelp { get; set; } = 20f;
	public override float HelpSteerPower { get; set; } = 1f;
	public override float OppositeAngularVelocityHelpPower { get; set; } = 0.2f;
	public override float PositiveAngularVelocityHelpPower { get; set; } = 0.2f;
	...
	public override PacejkaCurve FrictionPreset { get; set; } = PacejkaCurve.AsphaltWet;
}
