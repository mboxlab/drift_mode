...
public partial class DifferentialComponent : PowertrainComponent
{
	...
	/// </summary>
	[Property, Range( 0, 1 )] public float Stiffness { get; set; } = 0.5f;

	/// <summary>
	/// Stiffness of the LSD differential under acceleration.
	/// </summary>
	[Property, Range( 0, 1 )] public float PowerRamp { get; set; } = 1f;

	/// <summary>
	/// Stiffness of the LSD differential under braking.
	/// </summary>
	[Property, Range( 0, 1 )] public float CoastRamp { get; set; } = 0.5f;
	...
	/// </summary>
	[Property] public float SlipTorque { get; set; } = 400f;
